...
export async function getById(req: Request, res: Response, next: NextFunction) {
  try {
    const section = await sectionsService.getById(parseInt(req.params.id));
...
export async function update(req: Request, res: Response, next: NextFunction) {
  try {
    const section = await sectionsService.update(parseInt(req.params.id), req.body);
    ApiResponse.success(res, section);
  } catch (err) { next(err); }
}
...
export async function remove(req: Request, res: Response, next: NextFunction) {
  try {
    await sectionsService.remove(parseInt(req.params.id));
